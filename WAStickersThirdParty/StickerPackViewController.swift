...
class StickerPackViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = stickersCollectionView.backgroundColor
        
        if #available(iOS 12.0, *) {
            if traitCollection.userInterfaceStyle == .dark {
                bottomGradientView = GradientView(topColor: UIColor.black.withAlphaComponent(0.0), bottomColor: UIColor.black)
            }
        }
        ...
        if #available(iOS 12.0, *) {
            if traitCollection.userInterfaceStyle == .dark {
                topDivider.backgroundColor = UIColor(named: "secondary_background")!.withAlphaComponent(0.2)
            }
        }
        ...
        if #available(iOS 12.0, *) {
            if traitCollection.userInterfaceStyle == .dark {
                shareButton.backgroundColor = UIColor(named: "secondary_background")!
            }
        }
        view.addSubview(shareButton)

        stickerPackPublisherLabel.text = "\(stickerPack.publisher)"
        ...
        let trailingPortraitShareConstraint = NSLayoutConstraint(item: view, attribute: .trailing, relatedBy: .equal, toItem: shareButton, attribute: .trailing, multiplier: 1.0, constant: 7)
        ...
        portraitConstraints.append(trailingPortraitShareConstraint)
        landscapeConstraints.append(centerLandscapeShareConstraint)
        view.addConstraint(trailingPortraitShareConstraint)
        view.addConstraint(centerLandscapeShareConstraint)
        let widthPortraitShareConstraint = NSLayoutConstraint(item: shareButton, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .width, multiplier: 1, constant: buttonSize.width / 1.7)
        ...
        let topPortraitAddConstraint = NSLayoutConstraint(item: shareButton, attribute: .top, relatedBy: .equal, toItem: addButton, attribute: .top, multiplier: 1.0, constant: 0)
        ...
        portraitConstraints.append(topPortraitAddConstraint)
        landscapeConstraints.append(bottomLandscapeAddConstraint)
        view.addConstraint(topPortraitAddConstraint)
        view.addConstraint(bottomLandscapeAddConstraint)
        let centerPortraitAddConstraint = NSLayoutConstraint(item: shareButton, attribute: .leading, relatedBy: .equal, toItem: addButton, attribute: .trailing, multiplier: 1.0, constant: 7.0)
        ...
        let widthPortraitAddConstraint = NSLayoutConstraint(item: addButton, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .width, multiplier: 1.0, constant: buttonSize.width / 1.22)
